...
button.addEventListener("click", calculatePalindromeBirthday);




function calculatePalindromeBirthday() {
    let dobValue = dob.value
    if (dobValue.length !== 0) {
        let splitDate = dobValue.split('-')
        ...
        if (ifPalindrome) {
            ...
            outPut.innerHTML = `<h3>✨ Your Birthday is Palindrome. ✨</h3>`
        } else {
            ...
            if (countNext > countPrev) {
                ...
                outPut.innerHTML = `<p>Aww! Your birthday is not a palindrome.
